...
@hydra.main(config_path='config', config_name='config_cds', version_base=None)
def main(cfg: DictConfig):
    ...
    walk_path = Path('C:/Users/lenovo/Desktop/RL/Project/result_cds/05-30-00-29-walker_walk-Share_walker_walk_walker_run-medium-cql_cds')
    ...
    run_path = Path('C:/Users/lenovo/Desktop/RL/Project/result_cds/05-30-09-19-walker_run-Share_walker_run_walker_walk-medium-cql_cds')
